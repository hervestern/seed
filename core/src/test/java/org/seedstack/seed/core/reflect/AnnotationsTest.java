...
public class AnnotationsTest {
    ...
    private void checkNotAnnotated(Class<?> classToCheck, Class<? extends Annotation> annotationClass, boolean meta) throws NoSuchFieldException, NoSuchMethodException {
        assertThat(Annotations.on(classToCheck).find(annotationClass)).isNotPresent();
        assertThat(Annotations.on(classToCheck).traversingSuperclasses().traversingInterfaces().find(annotationClass)).isNotPresent();
    ...
    private void checkAnnotatedClass(Class<?> classToCheck, Class<? extends Annotation> annotationClass, boolean meta) throws NoSuchFieldException, NoSuchMethodException {
    ...
    private void checkAnnotatedByBaseClass(Class<?> classToCheck, Class<? extends Annotation> annotationClass, boolean meta) throws NoSuchFieldException, NoSuchMethodException {
        ...
        assertThat(on(classToCheck, false, meta).traversingSuperclasses().traversingInterfaces().find(annotationClass)).isPresent();
        ...
        assertThat(on(notAnnotatedField, true, meta).traversingSuperclasses().traversingInterfaces().find(annotationClass)).isPresent();
        ...
        assertThat(on(notAnnotatedMethod, true, meta).traversingSuperclasses().traversingInterfaces().find(annotationClass)).isPresent();
        ...
        assertThat(on(notAnnotatedConstructor, true, meta).traversingSuperclasses().traversingInterfaces().find(annotationClass)).isPresent();
    }
    ...
    private void checkAnnotatedByInterface(Class<?> classToCheck, Class<? extends Annotation> annotationClass, boolean meta) throws NoSuchFieldException, NoSuchMethodException {
        assertThat(on(classToCheck, false, meta).find(annotationClass)).isNotPresent();
        ...
        assertThat(on(notAnnotatedConstructor, false, meta).find(annotationClass)).isNotPresent();
        assertThat(on(notAnnotatedConstructor, true, meta).find(annotationClass)).isNotPresent();
        assertThat(on(notAnnotatedConstructor, true, meta).traversingSuperclasses().find(annotationClass)).isNotPresent();
    ...
    public void methodsAnnotatedByInterface() throws Exception {
        ...
        assertThat(Annotations.on(annotatedMethod).traversingOverriddenMembers().find(MethodAnnotation.class)).isPresent();
    }
