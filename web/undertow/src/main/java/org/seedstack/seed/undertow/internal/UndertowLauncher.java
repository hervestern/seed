...
import org.seedstack.seed.core.internal.config.legacy.LegacyConfigLoader;
...
public class UndertowLauncher implements SeedLauncher {
    ...
    public void launch(String[] args) throws Exception {
        ...
        manager = factory.createDeploymentManager(new LegacyConfigLoader().buildBootstrapConfig());
